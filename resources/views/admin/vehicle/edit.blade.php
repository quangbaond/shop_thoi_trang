...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <form class="row" action="{{route('admin.vehicles.update', $vehicle->id)}}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                                    ...
                                    <div class="card-body row">
                                        ...
                                        <x-admin-input-prepend label="Giá Nhập" col="col-6" width="auto">
                                            <input
                                                ...
                                                min="1"
                                                name="price_import"
                                                value="{{ old('price_import') ?? $vehicle->price_import ?? '' }}"
                                                class="form-control">
                                            @error('price_import')
                                            <div style="color: red; width: 100%;"> {{ $message }}</div>
                                            @enderror
                                        ...
                                        <x-admin-input-prepend label="Giá Bán" col="col-6" width="auto">
                                            <input
                                                ...
                                                type="number"
                                                name="price_sell"
                                                value="{{ old('price_sell') ?? $vehicle->price_sell ?? '' }}"
                                                class="form-control">
                                            @error('price_sell')
                                            <div style="color: red; width: 100%;"> {{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="card card-outline card-info col-12">
                                            ...
                                            <!-- /.card-header -->
                                            <div class="card-body">
                                                  <textarea id="summernote" name="description">{{ old('description') ?? $vehicle->description ?? '' }}</textarea>
                                                @error('description')
                                                <div style="color: red; width: 100%;"> {{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="card-body row">
                                        <x-admin-input-prepend label="Trọng lượng" width="auto" col="col-6">
                                            <input
                                                ...
                                                name="self_weight"
                                                class="form-control"
                                                value="{{ old('self_weight') ?? $vehicle->self_weight ?? '' }}"
                                            >
                                            @error('self_weight')
                                            <div style="color: red; width: 100%;"> {{ $message }}</div>
                                            @enderror
                                        ...
                                        <x-admin-input-prepend label="Kích thước" width="auto" col="col-6">
                                            <input
                                                ...
                                                value="{{ old('length_x_width_x_height') ?? $vehicle->length_x_width_x_height ?? '' }}"
                                                class="form-control">
                                        ...
                                        <x-admin-input-prepend label="Chiều cao yên xe" width="auto" col="col-6">
                                            <input
                                                ...
                                                type="text"
                                                name="saddle_height"
                                                value="{{ old('saddle_height') ?? $vehicle->saddle_height ?? '' }}"
                                                class="form-control">
                                            @error('saddle_height')
                                            <div style="color: red; width: 100%;"> {{ $message }}</div>
                                            @enderror
                                        ...
                                        <x-admin-input-prepend label="Khoảng sáng gầm xe" width="auto" col="col-6">
                                            <input
                                                ...
                                                value="{{ old('ground_clearance') ?? $vehicle->ground_clearance ?? '' }}"
                                                class="form-control">
                                        ...
                                        <x-admin-input-prepend label="Kích thước lốp trước" width="auto" col="col-6">
                                            <input
                                                ...
                                                value="{{ old('size_of_front_tire') ?? $vehicle->size_of_front_tire ?? '' }}"
                                                class="form-control">
                                        ...
                                        <x-admin-input-prepend label="Phuộc trước" width="auto" col="col-6">
                                            <input
                                                ...
                                                value="{{ old('front_shock_absorber') ?? $vehicle->front_shock_absorber ?? '' }}"
                                                class="form-control">
                                        ...
                                        <x-admin-input-prepend label="Phuộc sau" width="auto" col="col-6">
                                            <input
                                                ...
                                                value="{{ old('rear_shock_absorber') ?? $vehicle->rear_shock_absorber ?? '' }}"
                                                class="form-control">
                                        ...
                                        <x-admin-input-prepend label="Dung tích tối đa" width="auto" col="col-6">
                                            <input
                                                ...
                                                value="{{ old('maximum_capacity') ?? $vehicle->maximum_capacity ?? '' }}"
                                                class="form-control">
                                        ...
                                        <x-admin-input-prepend label="Dung tích nhớt máy" width="auto" col="col-6">
                                            <input
                                                ...
                                                value="{{ old('engine_oil_capacity') ?? $vehicle->engine_oil_capacity ?? '' }}"
                                                class="form-control">
                                        ...
                                        <x-admin-input-prepend label="Loại hộp số" width="auto" col="col-6">
                                            <input
                                                ...
                                                value="{{ old('transmission_type') ?? $vehicle->transmission_type ?? '' }}"
                                                class="form-control">
                                        ...
                                        <x-admin-input-prepend label="Hệ thống khởi động" width="auto" col="col-6">
                                            <input
                                                ...
                                                value="{{ old('starting_system') ?? $vehicle->starting_system ?? '' }}"
                                                class="form-control">
                                        ...
                                        <x-admin-input-prepend label="Moment cực đại" width="auto" col="col-6">
                                            <input
                                                ...
                                                type="text"
                                                name="maximum_moment"
                                                value="{{ old('maximum_moment') ?? $vehicle->maximum_moment ?? '' }}"
                                                class="form-control">
                                        ...
                                        <x-admin-input-prepend label="Đường kính x Hành trình pít tông" width="auto" col="col-6">
                                            <input
                                                ...
                                                value="{{ old('diameter_x_piston_stroke') ?? $vehicle->diameter_x_piston_stroke ?? '' }}"
                                                class="form-control">
                                        ...
                                        <x-admin-input-prepend label="Tỷ số nén" width="auto" col="col-6">
                                            <input
                                                ...
                                                value="{{ old('compression_ratio') ?? $vehicle->compression_ratio ?? '' }}"
                                                class="form-control">
                                        ...
                                        <div class="col-12">
                                            <div class="card-body">
                                                <div class="container">
                                                    <div class="preview">
                                                        <img id="img-preview" src="{{ asset('asset/client/images/products/vehicle/' . $vehicle->image) }}" />
