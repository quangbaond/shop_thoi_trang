                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        ...
                        <a href="{{ route('admin.users_index') }}"
                           class="nav-link {{ ($isRouteUser) ? 'active' : '' }}">
                    ...
                    @if (Auth::guard('admin')->user()->role_id == 1)
                        <li class="nav-item">
                            ...
                            @endphp
                            <a href="{{ route('admin.staffs_index') }}"
                               class="nav-link {{ ($isRouteUser) ? 'active' : '' }}">
...
{{--                    <li class="nav-item">--}}
{{--                        @php--}}
{{--                            $isRouteUser = request()->is('admin/category_vehicle*');--}}
{{--                        @endphp--}}
{{--                        <a href="{{ route('admin.category_vehicle.index') }}"--}}
{{--                           class="nav-link {{ ($isRouteUser) ? 'active' : '' }}">--}}
{{--                            <i class="nav-icon fas fa-inbox"></i>--}}
{{--                            <p>--}}
{{--                                {{ TextLayoutSidebar("category_vehicle") }}--}}
{{--                            </p>--}}
{{--                        </a>--}}
{{--                    </li>--}}
                    <li class="nav-item">
                        @php
                            $isRouteUser = request()->is('admin/vehicle*');
                        @endphp
                        <a href="{{ route('admin.vehicles.index') }}"
                           class="nav-link {{ ($isRouteUser) ? 'active' : '' }}">
                            <i class="nav-icon fas fa-inbox"></i>
                            <p>
                                {{ TextLayoutSidebar("vehicle") }}
                            </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        ...
                        @endphp
                        <a href="{{ route('admin.colors_index') }}"
                           class="nav-link {{ ($isRouteUser) ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        ...
                        @endphp
                        <a href="{{ route('admin.sizes_index') }}"
                           class="nav-link {{ ($isRouteUser) ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        ...
                        @endphp
                        <a href="{{ route('admin.brands_index') }}"
                           class="nav-link {{ ($isRouteUser) ? 'active' : '' }}">
                    ...
                    @if (Auth::guard('admin')->user()->role_id == 1)
                        <li class="nav-item">
                            ...
                            @endphp
                            <a href="{{ route('admin.payments_index') }}"
                               class="nav-link {{ ($isRouteUser) ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        ...
                        @endphp
                        <a href="{{ route('admin.orders_index') }}"
                           class="nav-link {{ ($isRouteUser) ? 'active' : '' }}">
                    ...
                    @if (Auth::guard('admin')->user()->role_id == 1)
                        <li class="nav-item">
                            ...
                            @endphp
                            <a href="{{ route('admin.setting_index') }}"
                               class="nav-link {{ ($isRouteUser) ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{route('admin.profile_change-profile')}}"
                           class="nav-link {{ (Route::is('admin.profile_change-profile')) ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{route('admin.profile_change-password')}}"
                           class="nav-link {{ (Route::is('admin.profile_change-password')) ? 'active' : '' }}">
