                    ...
                    @if($actions['viewDetail'] || $actions['edit'] || $actions['delete'])
                        <td>
                            ...
                            @if ($actions['viewDetail'])
                                <a id="btn-table-view-detail__js" class="btn btn-info" href="{{ isset($routes['show']) ? route($routes['show'], $item->id) : '#' }}">
                                    <i class="fas fa-history"></i>
                                </a>
                            @endif
                            @if ($actions['delete'])
                                <form style="display: inline;" action="{{route($routes['delete'])}}" method="POST"
                                      id="form-delete__js">
                                    @csrf
