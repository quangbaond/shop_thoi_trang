...
Route::middleware(['maintenance'])->group(function () {
    ...
    Route::get('products/vehicles', [VehicleController::class, "index"])->name('user.products_vehicle');
    Route::get('products/vehicles/{slug}', [VehicleController::class, "detail"])->name('user.products_vehicle_detail');
