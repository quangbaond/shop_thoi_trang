...
use App\Http\Controllers\Admin\{UserController, VehicleController, CategoryVehicle};
...
Route::middleware(['auth.admin', 'admin.verified'])->group(function () {
    ...
    Route::middleware('auth.admin_author:admin')->group(function () {
        ...
        Route::post('vehicles/delete', [VehicleController::class, "delete"])->name('admin.vehicles.delete');
    });
});
